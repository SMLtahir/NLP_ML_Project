...
/**
 * Measures the ratio of plural to singular words used by the speaker.
    ...
    implements DocumentFeatureExtractor
{
        ...
        throws TextClassificationException
    {
        ...
        featList.addAll(Arrays.asList(new Feature(FN_PLURAL_RATIO+"Teacher", (singularTeacher + pluralTeacher) == 0 ? 0 :
            (double) pluralTeacher / (singularTeacher + pluralTeacher))));
        featList.addAll(Arrays.asList(new Feature(FN_PLURAL_RATIO+"Student", (singularStudent + pluralStudent) == 0 ? 0 :
