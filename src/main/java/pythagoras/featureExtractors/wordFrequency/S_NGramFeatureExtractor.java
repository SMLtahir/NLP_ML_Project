...
import pythagoras.featureExtractorUtils.S_NGramMetaCollector;
...
/**
 * Feature extractor based on the frequency on ngrams in student utterances
 * 
    ...
    implements MetaDependent, ClassificationUnitFeatureExtractor
{
    ...
    public List<Class<? extends MetaCollector>> getMetaCollectorClasses()
    {
        ...
        metaCollectorClasses.add(S_NGramMetaCollector.class);
        ...
        throws ResourceInitializationException
    {
        try {
            ...
            trainingFD.load(new File(studentNgramFdFile));
        }
        catch (IOException e) {
    ...
    protected FrequencyDistribution<String> getDocumentNgrams(JCas jcas)
    {
    	...
    	return NGramUtils.getStudentNgrams(jcas, ngramLowerCase, filterPartialStopwordMatches, ngramMinN, ngramMaxN, stopwords);
    }
