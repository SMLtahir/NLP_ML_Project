 ...
 * 
 * This feature extractor extracts the teacher's mood by this grammatical logic.
 * @author Tahir Sousa
    ...
    implements DocumentFeatureExtractor
{
...

    {
        ...
        featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ VIMP_PER_VERB + "_T", nrOfVerbs!=0? nrImperativVerbs / nrOfVerbs: 0)));
        featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ VKONJ_PER_VERB + "_T", nrOfVerbs!=0? nrKonjunctivVerbs / nrOfVerbs: 0)));
        featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ VIND_PER_VERB + "_T", nrOfVerbs!=0? nrIndicativVerbs / nrOfVerbs: 0)));
        
        featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ VIMP_PER_CONV + "_T", nrImperativVerbs / nrOfConversations)));
        featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ VKONJ_PER_CONV + "_T", nrKonjunctivVerbs / nrOfConversations)));
        featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ VIND_PER_CONV + "_T", nrIndicativVerbs / nrOfConversations)));
