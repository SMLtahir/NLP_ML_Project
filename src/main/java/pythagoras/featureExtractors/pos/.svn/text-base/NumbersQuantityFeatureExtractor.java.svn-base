...
/**
 * Feature extractor based on the frequency of cardinal numbers
 * 
 * @author Tahir Sousa
...
{
	private static final String GROUP_PREFIX = "CSyn_NumQ__";
        ...
        throws TextClassificationException
    {
        ...
        featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ "AmountOfNumbersByTeacher", numbersByTeacher/nrOfTeacherConversations)));
        featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ "AmountOfNumbersByStudent", numbersByStudent/nrOfStudentConversations)));
        featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ "TotalAmountOfNumbers", totalNumbers/nrOfConversations)));
        return featList;
    }
