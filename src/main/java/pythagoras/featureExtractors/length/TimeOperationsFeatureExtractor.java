...
/**
 * Measures talk times of speakers 
 * 
 * @author Tahir Sousa
...
implements DocumentFeatureExtractor {
	...
	private static final String GROUP_PREFIX = "CSur_Time__";
	...
	public List<Feature> extract(JCas view) throws TextClassificationException {
		...
		featList.add(new Feature(GROUP_PREFIX+ "NrOfSpeakerChanges", speakerChange/nrConversations));
		featList.add(new Feature(GROUP_PREFIX+ "TeacherTalkTimePercentage", 100*teacherTotalTalkTime / lessonTotalTime));
		featList.add(new Feature(GROUP_PREFIX+ "StudentTalkTimePercentage", 100*studentTotalTalkTime / lessonTotalTime));
		featList.add(new Feature(GROUP_PREFIX+ "TeacherTalkNoTalkRatio", teacherTotalTalkTime / teacherTotalNoTalkTime));
		featList.add(new Feature(GROUP_PREFIX+ "StudentTalkNoTalkRatio", studentTotalTalkTime / studentTotalNoTalkTime));
		featList.add(new Feature(GROUP_PREFIX+ "TeacherStudentTalkTimeRatio", teacherTotalTalkTime/studentTotalTalkTime));
		featList.add(new Feature(GROUP_PREFIX+ "TeacherConversationsTimeRatio", teacherConversations/teacherTotalTalkTime));
		featList.add(new Feature(GROUP_PREFIX+ "StudentConversationsTimeRatio", studentConversations/studentTotalTalkTime));
		return featList;
	}
