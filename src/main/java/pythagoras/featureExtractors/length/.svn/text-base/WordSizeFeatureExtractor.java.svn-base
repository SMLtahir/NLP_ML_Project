...
/**
 * Calculates the proportions of tokens in 4 categories based on length of token.
 *  
 * @author Tahir Sousa
    ...
    implements DocumentFeatureExtractor
{
    ...
    private static final String GROUP_PREFIX = "CSur_WSize__";
    ...
    public List<Feature> extract(JCas jcas)
    {
        ...
        featList.add(new Feature(GROUP_PREFIX+ FN_LW_RATIO + "_Teacher", longTokenRatio_Teacher));
        featList.add(new Feature(GROUP_PREFIX+ FN_SW_RATIO + "_Teacher", shortTokenRatio_Teacher));
        featList.add(new Feature(GROUP_PREFIX+ FN_VLW_RATIO + "_Teacher", veryLongTokenRatio_Teacher));
        featList.add(new Feature(GROUP_PREFIX+ FN_VSW_RATIO + "_Teacher", veryShortTokenRatio_Teacher));
        
        featList.add(new Feature(GROUP_PREFIX+ FN_LW_RATIO + "_Student", longTokenRatio_Student));
        featList.add(new Feature(GROUP_PREFIX+ FN_SW_RATIO + "_Student", shortTokenRatio_Student));
        featList.add(new Feature(GROUP_PREFIX+ FN_VLW_RATIO + "_Student", veryLongTokenRatio_Student));
        featList.add(new Feature(GROUP_PREFIX+ FN_VSW_RATIO + "_Student", veryShortTokenRatio_Student));
