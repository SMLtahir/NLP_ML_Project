...
/**
 * Meta-collector for {@link S_AdverbsFeatureExtractor}.
 * 
 * Adopted from DKPro TC
 * @version last updated: Apr 03, 2014 [Sousa]
 */
public class S_AdverbsMetaCollector
    extends FreqDistBasedMetaCollector
{
    public static final String S_ADVERBS_FD_KEY = "S_adverbs.ser";

    @ConfigurationParameter(name = S_AdverbsFeatureExtractor.PARAM_S_ADVERBS_FD_FILE, mandatory = true)
    private File studentAdverbsFdFile;
    ...
    public Map<String, String> getParameterKeyPairs()
    {
        ...
        mapping.put(S_AdverbsFeatureExtractor.PARAM_S_ADVERBS_FD_FILE, S_ADVERBS_FD_KEY);
        return mapping;
    }
