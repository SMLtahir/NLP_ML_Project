...
/**
 * Meta-collector for {@link ChunkTripleFeatureExtractor}.
 * 
    ...
    extends FreqDistBasedMetaCollector
{
    ...
    private File allChunkTripleFdFile;
    ...
    @ConfigurationParameter(name = ChunkTripleFeatureExtractor.PARAM_CHUNK_TRIPLE_STOPWORDS_FILE, mandatory = false)
