...
/**
 * Contains several utility methods used especially by NGram-based feature extractors and meta-collectors. 
 * 
 * @author Tahir Sousa
...
public class NGramUtils
{
    ...
    */
     ...
     * @param newContent new content to be written to file
     ...
     */
  	...
  	/**
     * Cleans up a list of tokens off all punctuations and special characters and retains only words 
     * @param tokens list of a mix of words and punctuations
    ...
    public static List<String> removeSpecialCharacters(List<String> tokens)	{
    	...
    	for	(String token : tokens)	{
    		String temp = token.replaceAll("[^\\p{L}\\p{Z}]","");				//Remove all punctuation and special symbols			
    		token = temp;
