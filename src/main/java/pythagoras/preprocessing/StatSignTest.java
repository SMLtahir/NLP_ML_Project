...
public class StatSignTest {
	...
	public static final String CheckFileDir = "C:\\Users\\Home\\Desktop\\Pythagoras data\\Stat sign test\\results files\\BestRun\\";
	
	//public static final String[] DIMENSIONS = {"relev", "rez", "gem", "denk", "koop", "rueck", "anerl", "global"};
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("End of runs.");
	}
