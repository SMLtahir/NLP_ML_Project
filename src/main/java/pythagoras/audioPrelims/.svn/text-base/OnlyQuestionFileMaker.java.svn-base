...
/**
 * Makes Praat-readable .tsv files containing only teacher's utterances which contain question sentences.
 ...
 */
public class OnlyQuestionFileMaker {
	...
	public static String OUTPUT_DIRECTORY = "E:\\Eclipse\\de.tudarmstadt.ukp.dkpro.tc.experiment.pythagoras\\src\\main\\resources\\PraatReadableTSV\\OnlyQuestionFiles\\";
